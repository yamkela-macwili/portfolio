        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="flex-grow text-center md:text-left">
            <h2 className="text-2xl md:text-3xl font-medium text-white mb-4">
              I’m currently open to Full-Stack, Backend, and Data Engineering roles.
            </h2>
            <p className="text-zinc-400 text-lg font-light leading-relaxed max-w-2xl">
              I’m eager to contribute across the stack, collaborate with experienced teams, and build scalable systems, robust data pipelines, and AI-powered applications.
            </p>
          </div>
